# Borrowed from sd-webui-controlnet's installation file.
            ...
            try:
                ...
                if "==" in package:
                    ...
                    if installed_version != package_version:
                        launch.run_pip(
                            f"install -U {package}",
                            f"diffusion-canvas requirement: changing {package_name} version from {installed_version} to {package_version}",
                        )
                elif ">=" in package:
                    package_name, package_version = package.split(">=")
                    installed_version = get_installed_version(package_name)
                    ...
                    launch.run_pip(
                        f"install {package}",
                        f"diffusion-canvas requirement: {package}",
                    )
